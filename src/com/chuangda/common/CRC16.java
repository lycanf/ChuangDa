...
public class CRC16 {
	 ...
	 * @return CRC16鏍￠獙鍊�
	 */
	private static byte[] calcCrc16(byte[] data, int offset, int len, int preval) {
		...
		byte[] ret = new byte[2];
		ret[0] = (byte) (ucCRCLo & 0xffff);
		ret[1] = (byte) (ucCRCHi & 0xffff);
		
//		System.out.println(String.format("xxx 0x%02x", ret[0]));
//		System.out.println(String.format("xxx 0x%02x", ret[1]));
		return ret;
	}
